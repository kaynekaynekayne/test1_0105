            ...
            <b-row class="mt-3 pb-3">
              ...
              <b-col cols="5">
                <b-row>
                  ...
                  <b-col>
                    <b-form-select v-model="pbAnalysisType2" :options="AnalysisList" size="sm" @change="onChangeSelect"></b-form-select>
                  </b-col>
                </b-row>
                <b-row class="mt-2">
                  <b-col cols="4" class="p-0">
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      // pbAnalysisType -> pb(s)의 cell analyzing count
      this.pbAnalysisType = this.getSettings.pbAnalysisType
      // pbp 추가, pbAnalysisType2 -> pb(p)의 cell analyzing count
      this.pbAnalysisType2 = this.getSettings.pbAnalysisType2
    ...
    methods: {
      ...
      onChangeSelect () {
        var obj = {
          ...
          // pbp 추가
          pbAnalysisType2: this.pbAnalysisType2,
