  ...
  export default {
    ...
    methods: {
      ...
      onClickDegree (evt, rbc) {
        console.log(evt)
        console.log(rbc)
        // MouseEvent, {CASSET_ID:"casspb" CATEGORY_ID : "02" CATEGORY_NM : "Chromia" CLASS_ID : "02" CLASS_NM : "Hyperchromic" DEGREE : "0" SLOT_ID :"20231016144955_11_20231016151505"}
        ...
        if (!self.isBefore) {
          if (evt.target.id !== '' && evt.target.id.length === 5) {
            ...
            // 01042 -> categoryid = 01 (size) classid = 02 (Anisocytosis) degree = 2
