            ...
            <b-row class="mt-2 mb-2 pl-3">
              ...
              <b-col>
                ...
                <!-- <img class="pointer" src="~@/assets/result/excel.png"
                  ...
                  <!-- <b-icon v-if="siteCd !== '0007'" class="ml-2 pointer"
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      // 밑에 얘 없으면 mounted 될 때 마다 체크 표시 풀림
    ...
    methods: {
      ...
      updateSearchOption () {
        ...
        console.log('update search option')
        console.log(obj)
